    ...
    public partial class frmCars : Form
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (currentRow < recordsCount - 1)
                {
                    currentRow++;
                    txtVehicleRegNo.Text = dataTable.Rows[currentRow].Field<string>(0);
                    txtMake.Text = dataTable.Rows[currentRow].Field<string>(1);
                    txtEngineSize.Text = dataTable.Rows[currentRow].Field<string>(2);
                    txtDateRegistered.Text = Convert.ToString(dataTable.Rows[currentRow].Field<DateTime>(3).ToString("dd/MM/yyyy"));
                    txtRentalPerDay.Text = Convert.ToString(dataTable.Rows[currentRow].Field<decimal>(4).ToString("C"));
                    chkAvailable.Checked = dataTable.Rows[currentRow].Field<bool>(5);
                }
                else
                {
                    btnFirst_Click(sender, e);
        ...
        public void UpdateRecordDisplay()
        {
            ...
            {
                recordsCount = dataTable.Rows.Count;
                txtRecord.Text = $"{currentRow + 1} of {recordsCount}";
            }
        }
